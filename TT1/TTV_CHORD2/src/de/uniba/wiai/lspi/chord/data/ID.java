...
public final class ID implements Comparable<ID>, Serializable {
	...
	public final String toString() {
		...
		String start = this.stringRepresentation.substring(0, 5);
		String end = this.stringRepresentation.substring(this.stringRepresentation.length() - 7, this.stringRepresentation.length() - 1);
		return start + "..." + end;
 	}
