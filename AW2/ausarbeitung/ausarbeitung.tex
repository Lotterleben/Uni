...
One example application for this may be a warehouse as illustrated in \ref{fig:ac_img} whose goods (or their packaging) are equipped ith IoT hardware. Employees are thus able to tell details about the stock simply by asking their scanner, which commincated with the other IoT devices. In case a truckload of new goods arrives, \todo{write less fussy}
