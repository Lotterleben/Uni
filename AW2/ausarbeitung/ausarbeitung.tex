...
%todo: rexplain bordercasting better? (TZRP paper may help)
...
% These clusters form a hierarchy, with the individual nodes at its very bottom.
% each node determines their location and joins the routing zone which spans across the area they're in. 
...
%Whenever a packet needs to travel outside the cluster, it is routed along the zone hierarchy. Because there are no cluster heads, a lot of flooding happens. \todo{disentangle the general WTFness of this protocols' operation}
