...
\todo{what if I ``hack'' a route-centered one in such a way that I define all n-hop neighbors as sink nodes, too? I'd have a hybrid-hybrid :D SHARP and ZHLS basically do this...}
