...
Because the IoT is an umbrella term for many different use cases, none of these approaches is necessarily better than the other. Even combinations of both paradigms could be feasible. Which approach is suitable depends on traffic and mobility patterns (caused by different usage scenarios) and the roles of all nodes involved.
