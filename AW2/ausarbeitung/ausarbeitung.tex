...
\begin{table*}[t]
    \begin{tabular}{p{0.5\textwidth}|l|l|l}
        ...
        \hline
        Node-Centric Hybrid Routing \cite{Roy_nodecentric} & Path & Framework & 2002 \\ % proactive fixed
        SHARP\cite{SHARP} & Area and path & Framework & 2003 \\ %TODO: only for reactive!
        P2P extension\cite{RFC-6997} of RPL\cite{RFC-6550} & Path & Protocol & 2013\\
        ZRP \cite{ZRP-Draft} and extensions \cite{TZRP} \cite{IZR} \cite{WARP} & Area & Protocol & 2002/2004\\
%        \gls{WARP}\cite{WARP} & Area and Path & Protocol & 2002\\ % TODO: evtl doch mit reinnehmen und auseinandernehmen?
        ZHLS\cite{ZHLS} & Area & Protocol & 1999\\
        HYMAD\cite{HYMAD} & Area & Framework & 2010\\ % Only DTN protocol is variable!
    \end{tabular}
