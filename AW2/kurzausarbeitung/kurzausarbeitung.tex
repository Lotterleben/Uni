...
Area-centered routing protocols distinguish routes by locality: nearby routes are maintained in a proactive fashion, while routes to destinations farther away in the network are maintained reactively.\\
...
Examples for route-centered protocols are \cite{Roy_nodecentric} and the P2P extension\cite{RFC-6997} of the \gls{RPL}\cite{RFC-6550}.\\
% TODO: examples are 
% -> SHARP
