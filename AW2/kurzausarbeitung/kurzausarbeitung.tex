...
Since proactive and reactive protocols are suitable under different circumstances, the decision which of the two routing paradigms is employed is made based the current network behavior.
...
\section{pros \& cons of proactive vs reactive}
...
- the P2P extension\cite{RFC-6997} of the \gls{RPL}\cite{RFC-6550}
...
TODO: write about stuff that the papers from ``Experimental Work'' described
