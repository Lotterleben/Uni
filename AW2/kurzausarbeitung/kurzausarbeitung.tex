...
what ere the up- and downsides to oth, what do we want to keep?

\subsection{Requirements for Hybrid Routing}
What should Hybrid routing protocols be good at?

\section{Related Work} % TOSO: section title too generic?

Existing approaches to hybrid routing can be categorized as either area-centered or route-centered.\\
\emph{Area-centered} routing protocols
