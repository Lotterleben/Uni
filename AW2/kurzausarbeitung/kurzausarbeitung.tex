...
\begin{table*}[t]
 	\begin{tabular}{p{0.62\textwidth}|l|l}
		...
		\gls{WARP}\cite{WARP} & Area-Centered & TODO\\
		\gls{ZHLS}\cite{ZHLS} & TODO & TODO\\
	\end{tabular}
...
Some frameworks, like the \gls{SHARP}\cite{SHARP}, allow for the customization of only one part: in the case of ZHLS, any reactive routing protocol may be used, while the proactive component is fixed.
\end{description}
