...
\begin{enumerate}
\item a randomized list containing the IDs of all participating nodes is created. It should contain some duplicates. This is needed to create point-to-point traffic.
\item a randomized list containing tuples with randomized pairings of the IDs of all \emph{except for one} participating nodes is created. It should contain some duplicates. This is needed to create multipoint-to-point traffic.
\item an sample packet with a payload of 20 bytes, resulting in a 61-byte packet including IEEE 802.15.4. and IPv6 headers with applied 6LoWPAN header compression.
\end{enumerate}
...
The numbers used should be tweaked in case they are found to be unrealistic.

%TODO: mobility berücksichtigen! tatsächliche nummern benutzen.
...
%TODO: which metrics do I evaluate how?
